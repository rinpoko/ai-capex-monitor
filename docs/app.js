...
/* GitHub Pages版: バックエンドを持たず、GitHub Actionsが6時間ごとに更新する
   静的JSON（data/snapshot.json）を読み込むだけの構成 */
...
(async () => {
  ...
  if (!ok) $("#loading").textContent = "データの読み込みに失敗しました。しばらくしてから再度お試しください。";
  // ページを開きっぱなしにしていても、GitHub Actionsの更新を追随して反映する
